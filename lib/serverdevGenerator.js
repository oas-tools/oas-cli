...
export function generateDevEnv(options) {
    ...
    if (options.cloneCommons) {
        fs.rmSync('oas-tools/node_modules/@oas-tools/commons', {recursive: true});
        execCommand('git clone -b develop https://github.com/oas-tools/oas-commons.git oas-tools/node_modules/@oas-tools/commons');
        fs.symlinkSync('oas-tools/node_modules/@oas-tools/commons', 'oas-commons', 'junction');
        execCommand('npm install', {cwd: 'oas-commons'});
    }
